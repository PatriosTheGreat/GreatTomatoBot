...
namespace TomatoBot.BotCommands
{
	public sealed class GetTotalStatistics : IBotCommand, ICommandWithHelpLine
	{
		...
		public string ExecuteAndGetResponse(MessageActivity activity)
		{
			...
			return $"Юзер, сообщений, слов, смайлов, атачей, длина{ActivityExtension.NewLine}{userStatistics}{ActivityExtension.NewLine}Всего сообщений {totalStatistics.Sum(statistics => statistics.MessagesCount)}";
		}
